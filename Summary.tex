        ...
        \subsubsection{Polarization-Mode Dispersion}
            \begin{itemize}
                ...
                \item For a given value of Bm, the two modes exchange their powers in a periodic fashion as they propagate inside the fiber with the Beat Length period
                    ...
                    \end{equation}
                    The intuition of Beat length can be illustrated by \autoref{beat lenght illustration}.
                    \begin{figure}[htbp]
                        \centering
                        \includegraphics[width=0.6\textwidth]{images/polar dispersion.jpg}
                        \caption{Beat length illustration}
                        \label{beat lenght illustration}
                    \end{figure}
